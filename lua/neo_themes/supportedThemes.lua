-- This will act at the list of themes that are currently supported by the
-- neo-themes plugin
--
-- Creating this so the entire table is not reloaded every time a new theme is
-- install in the command file
return {
  'abstract-cs',
  'adwaita',
  'apprentice',
